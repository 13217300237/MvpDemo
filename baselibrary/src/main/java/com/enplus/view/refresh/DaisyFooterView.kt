...
import com.enplus.mvp.R

import com.enplus.view.refresh.contract.PushContract
...
class DaisyFooterView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : RelativeLayout(context, attrs),
    PushContract {
